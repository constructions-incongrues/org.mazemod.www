...
abstract class BaseJob extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the handler field.
	 * @var        string
	 */
	protected $handler;
	...
	/**
	 * Set the value of [handler] column.
	 * 
	...
	public function setHandler($v)
	{
		...
		if ($this->handler !== $v) {
			$this->handler = $v;
			$this->modifiedColumns[] = JobPeer::HANDLER;
		}
	...
	public function setData($v)
	{
		...
		if ($this->data !== $v) {
			$this->data = $v;
			$this->modifiedColumns[] = JobPeer::DATA;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->handler = $rs->getString($startcol + 0);

			$this->data = $rs->getString($startcol + 1);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setHandler($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(JobPeer::HANDLER)) $criteria->add(JobPeer::HANDLER, $this->handler);
		if ($this->isColumnModified(JobPeer::DATA)) $criteria->add(JobPeer::DATA, $this->data);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setHandler($this->handler);
