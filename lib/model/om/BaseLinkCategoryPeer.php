...
abstract class BaseLinkCategoryPeer {
	...
	const NAME = 'link_category.NAME';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'link_category.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'link_category.UPDATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Name', 'CreatedAt', 'UpdatedAt', 'Id', ),
		BasePeer::TYPE_COLNAME => array (LinkCategoryPeer::NAME, LinkCategoryPeer::CREATED_AT, LinkCategoryPeer::UPDATED_AT, LinkCategoryPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('name', 'created_at', 'updated_at', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Name' => 0, 'CreatedAt' => 1, 'UpdatedAt' => 2, 'Id' => 3, ),
		BasePeer::TYPE_COLNAME => array (LinkCategoryPeer::NAME => 0, LinkCategoryPeer::CREATED_AT => 1, LinkCategoryPeer::UPDATED_AT => 2, LinkCategoryPeer::ID => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('name' => 0, 'created_at' => 1, 'updated_at' => 2, 'id' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	const COUNT = 'COUNT(link_category.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT link_category.ID)';
    ...
    foreach (sfMixer::getCallables('BaseLinkCategoryPeer:doSelectRS:doSelectRS') as $callable)
    {
      call_user_func($callable, 'BaseLinkCategoryPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseLinkCategoryPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseLinkCategoryPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseLinkCategoryPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseLinkCategoryPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseLinkCategoryPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseLinkCategoryPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseLinkCategoryPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseLinkCategoryPeer', $values, $con, $ret);
    }
