...
abstract class BaseLinkPeer {
	...
	const LINK_CATEGORY_ID = 'link.LINK_CATEGORY_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Title', 'Url', 'Description', 'LinkCategoryId', 'CreatedAt', 'UpdatedAt', 'Id', ),
		BasePeer::TYPE_COLNAME => array (LinkPeer::TITLE, LinkPeer::URL, LinkPeer::DESCRIPTION, LinkPeer::LINK_CATEGORY_ID, LinkPeer::CREATED_AT, LinkPeer::UPDATED_AT, LinkPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('title', 'url', 'description', 'link_category_id', 'created_at', 'updated_at', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Title' => 0, 'Url' => 1, 'Description' => 2, 'LinkCategoryId' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, 'Id' => 6, ),
		BasePeer::TYPE_COLNAME => array (LinkPeer::TITLE => 0, LinkPeer::URL => 1, LinkPeer::DESCRIPTION => 2, LinkPeer::LINK_CATEGORY_ID => 3, LinkPeer::CREATED_AT => 4, LinkPeer::UPDATED_AT => 5, LinkPeer::ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('title' => 0, 'url' => 1, 'description' => 2, 'link_category_id' => 3, 'created_at' => 4, 'updated_at' => 5, 'id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
    ...
    foreach (sfMixer::getCallables('BaseLinkPeer:doSelectRS:doSelectRS') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseLinkPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseLinkPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseLinkPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseLinkPeer', $c, $con);
    }
		...
		LinkCategoryPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + LinkCategoryPeer::NUM_COLUMNS;
