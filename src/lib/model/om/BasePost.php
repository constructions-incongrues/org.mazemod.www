...
abstract class BasePost extends BaseObject  implements Persistent {
	...
	public function setIsEnabled($v)
	{
		...
		if ($this->is_enabled !== $v) {
			$this->is_enabled = $v;
			$this->modifiedColumns[] = PostPeer::IS_ENABLED;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->is_enabled = $rs->getBoolean($startcol + 2);
			...
			return $startcol + 6; // 6 = PostPeer::NUM_COLUMNS - PostPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PostPeer::IS_ENABLED)) $criteria->add(PostPeer::IS_ENABLED, $this->is_enabled);
