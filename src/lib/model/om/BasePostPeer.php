...
abstract class BasePostPeer {
	...
	const IS_ENABLED = 'post.IS_ENABLED';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Title', 'Body', 'IsEnabled', 'CreatedAt', 'UpdatedAt', 'Id', ),
		BasePeer::TYPE_COLNAME => array (PostPeer::TITLE, PostPeer::BODY, PostPeer::IS_ENABLED, PostPeer::CREATED_AT, PostPeer::UPDATED_AT, PostPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('title', 'body', 'is_enabled', 'created_at', 'updated_at', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Title' => 0, 'Body' => 1, 'IsEnabled' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, 'Id' => 5, ),
		BasePeer::TYPE_COLNAME => array (PostPeer::TITLE => 0, PostPeer::BODY => 1, PostPeer::IS_ENABLED => 2, PostPeer::CREATED_AT => 3, PostPeer::UPDATED_AT => 4, PostPeer::ID => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('title' => 0, 'body' => 1, 'is_enabled' => 2, 'created_at' => 3, 'updated_at' => 4, 'id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PostPeer::IS_ENABLED);
    ...
    foreach (sfMixer::getCallables('BasePostPeer:doSelectRS:doSelectRS') as $callable)
    {
